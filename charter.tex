...
\cellcolor[HTML]{C0C0C0} &
  \cellcolor[HTML]{C0C0C0} &
  \multicolumn{4}{|c|}{\multirow{-2}{*}{\cellcolor[HTML]{C0C0C0}Listar todos los nombres y roles del proyecto}} \\ \cline{3-6}
\rowcolor[HTML]{C0C0C0} 
\cellcolor[HTML]{C0C0C0} &
  \cellcolor[HTML]{C0C0C0} &
  \cellcolor[HTML]{C0C0C0} &
...
\cellcolor[HTML]{C0C0C0} &
  ...
  \multirow{-2}{*}{Orientador} &
  \multirow{-2}{*}{Equipo} &
  \multirow{-2}{*}{Cliente} \\ 
\rowcolor[HTML]{C0C0C0} 
\multirow{-5}{*}{\cellcolor[HTML]{C0C0C0}\begin{tabular}[c]{@{}c@{}}Código\\ WBS\end{tabular}} &
  \multirow{-5}{*}{\cellcolor[HTML]{C0C0C0}Nombre de la tarea} &
  \multirow{-2}{*}{\authorname} &
  \multirow{-2}{*}{\supname} &
  \multirow{-2}{*}{Martín Mello Teggia} &
  \multirow{-2}{*}{\clientename} \\ \hline
